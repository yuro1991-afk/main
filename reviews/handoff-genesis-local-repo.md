...
3. Leave `yuro1991-afk/main` as the claimable board, not a Genesis duplicate

## Verify

A local Origin clone exists. GitHub `yuro1991-afk/main` is still the ops
pad, not a Genesis tree.
