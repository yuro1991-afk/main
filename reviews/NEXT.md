...
Keep-busy tick **2026-09-15T03:32Z**: 40 IDLE + this run RUNNING.
...
`0734e87`. Shipped this interval: `dronehive-mount-fabric-root`
default_drone_root afterApply. Leftover `next` stays alone. Do not invent leftovers.
...
| next afterApply to wire | `dronehive-mount-smoke-seal` (apps/drone-ollama-mount/src/main.rs SMOKE_SEAL only) |
...
Next afterApply to wire is `dronehive-mount-smoke-seal`.
