...
`bac9409`. Shipped this interval: `dronehive-seed-work-order-live-mirror`
seed mirror afterApply. Leftover `next` stays alone. Do not invent leftovers.
...
| next afterApply to wire | `dronehive-work-order-core-lessons` (work_order.json core_lessons only; -U1) |
...
Next afterApply to wire is `dronehive-work-order-core-lessons`.
