...
`bloom-grok-pwa-test-sync`. Catalog still 162. Hunt closed. Playbook
scoring now needs two id/name hits, so "ship something useful" does
not steal `catalog-compound-eng-feature`. Do not invent leftovers.
