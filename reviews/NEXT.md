...
Keep-busy tick **2026-09-15T01:24Z**: 40 IDLE + this run RUNNING.
...
`2f1fd61`. Shipped this interval: `dronehive-seed-work-order-doc-live-registry`
seed live-registry afterApply. Leftover `next` stays alone. Do not invent leftovers.
...
| next afterApply to wire | `dronehive-work-order-doc-codex-paths` (docs codex table only) |
...
(Primary/Mirror/CLI use `host/ai-center` and `host/library`).
Next afterApply to wire is `dronehive-work-order-doc-codex-paths`.
