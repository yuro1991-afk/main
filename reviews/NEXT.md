...
Keep-busy tick **2026-09-15T01:22Z**: 40 IDLE + this run RUNNING.
...
`733d7bf`. Shipped this interval: `dronehive-work-order-doc-live-registry`
docs live-registry afterApply. Leftover `next` stays alone. Do not invent leftovers.
...
| next afterApply to wire | `dronehive-seed-work-order-doc-live-registry` (seed docs live-registry table + $reg only) |
...
Next afterApply to wire is `dronehive-seed-work-order-doc-live-registry`.
