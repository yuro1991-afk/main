...
test("cli assign --missing lists catalog leftovers with no launch and never writes", async () => {
  ...
  assert.equal(parsed.nextMissing, null);
...
test("on-disk unicode launch is an Apply brief, not PR #5 autofix", () => {
  ...
  assert.match(leftover, /#47/);
  assert.match(leftover, /#50/);
  assert.match(leftover, /#51/);
  assert.match(leftover, /#54/);
  assert.match(leftover, /#55/);
  assert.match(leftover, /#58/);
  assert.match(leftover, /#59/);
  assert.match(leftover, /#62/);
  assert.match(leftover, /#63/);
  assert.match(leftover, /#65/);
  assert.match(leftover, /#66/);
  assert.match(leftover, /#68/);
  assert.match(leftover, /#69/);
  assert.match(leftover, /#72/);
  assert.match(leftover, /#73/);
  assert.match(leftover, /#76/);
  assert.match(leftover, /#77/);
  assert.match(leftover, /#80/);
  assert.match(leftover, /#81/);
  assert.match(leftover, /#84/);
  assert.match(leftover, /#85/);
  assert.match(leftover, /#88/);
  assert.match(leftover, /#89/);
  assert.match(leftover, /#92/);
  assert.match(leftover, /#93/);
  assert.match(leftover, /#96/);
  assert.match(leftover, /#97/);
  assert.match(leftover, /#100/);
});
...
test("unused leftover launch packets exist for parked next cards", () => {
  const ids = [
    ...
    "dronehive-work-order-doc-board",
    "dronehive-seed-work-order-doc-board",
    "opensussy-superpowers-lab-plan",
    "opensussy-superpowers-lab-design",
    "faceswap-honesty-located-paths",
    "dronehive-work-order-registry-cli",
    ...
    "dronehive-work-order-live-mirror",
    "dronehive-seed-work-order-live-mirror",
    "dronehive-work-order-core-lessons",
    "dronehive-seed-work-order-core-lessons",
    "dronehive-work-order-ai-smarts-packs",
    "dronehive-seed-work-order-ai-smarts-packs",
  ];
  for (const id of ids) {
